...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.build_date.utc";
    ...
    static final String PROP_DEVICE = "ro.ancient.device";
    static final String PROP_BUILD_VERSION = "ro.ancient";
    static final String PROP_VERSION_CODE = "ro.ancient.ota.version_code";
    static final String OTA_URL = "https://raw.githubusercontent.com/Ancient-Lab/Updater-stuff/master/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/Ancient-Lab/Updater-stuff/master/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "ancient-Updates/";
}
